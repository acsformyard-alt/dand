...
const PlayerSessionView: React.FC<PlayerSessionViewProps> = ({
  ...
  return (
    <div className="flex h-[78vh] min-h-[540px] flex-col overflow-hidden rounded-2xl border border-white/60 bg-white/60 shadow-xl shadow-amber-500/10 backdrop-blur-xl dark:border-slate-800/70 dark:bg-slate-950/70 dark:shadow-black/40">
