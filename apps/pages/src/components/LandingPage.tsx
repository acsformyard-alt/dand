        ...
        <header className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-6 py-8 sm:py-10">
          <div className="flex items-center gap-4">
            <div className="relative flex h-16 w-16 items-center justify-center">
              <div
                aria-hidden
                className="pointer-events-none absolute -inset-[25vw] rounded-full opacity-0 blur-[240px] transition-opacity duration-700 dark:opacity-95 dark:bg-[radial-gradient(circle_200%_at_center,rgba(253,224,71,0.7),rgba(17,24,39,0))]"
              />
