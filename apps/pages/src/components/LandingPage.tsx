        ...
        <header className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-6 py-8 sm:py-10">
          <div className="flex items-center gap-4">
            <div className="relative flex h-16 w-16 items-center justify-center">
              <div
                aria-hidden
                className="pointer-events-none absolute -inset-[30vw] rounded-full opacity-0 blur-[220px] transition-opacity duration-700 dark:opacity-100 dark:mix-blend-screen dark:bg-[radial-gradient(circle_220%_at_center,rgba(255,243,176,0.9),rgba(253,186,116,0.6),rgba(17,24,39,0))]"
              />
