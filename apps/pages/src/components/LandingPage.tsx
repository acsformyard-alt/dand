        ...
        <header className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-6 py-8 sm:py-10">
          <div className="flex items-center gap-4">
            <div className="relative flex h-16 w-16 items-center justify-center">
              <div
                aria-hidden
                className="pointer-events-none absolute -inset-[32vw] rounded-full opacity-0 blur-[220px] transition-opacity duration-700 dark:opacity-100 dark:mix-blend-screen dark:bg-[radial-gradient(circle_240%_at_center,rgba(253,224,71,0.95)_0%,rgba(251,191,36,0.65)_32%,rgba(249,115,22,0.38)_55%,rgba(17,24,39,0.18)_78%,rgba(17,24,39,0)_100%)]"
              />
