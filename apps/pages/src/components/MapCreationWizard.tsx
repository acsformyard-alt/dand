              ...
              <div className="w-full max-w-4xl rounded-3xl border border-slate-800/70 bg-slate-900/70 p-8 text-center">
                ...
                >
                  ...
                  <button
                    ...
                    className="mt-5 rounded-full border border-amber-400/60 bg-amber-500/80 px-6 py-3 text-xs font-semibold uppercase tracking-[0.3em] text-slate-900 transition hover:bg-amber-400/90"
                  >
                    Browse Files
                  </button>
                </div>
                ...
                <div className="border-b border-slate-800/70 p-4">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <button
                      ...
                      className="rounded-full border border-amber-400/60 bg-amber-500/80 px-4 py-2 text-[10px] font-semibold uppercase tracking-[0.3em] text-slate-900 transition hover:bg-amber-400/90"
                    >
                      Add Marker
                    </button>
                  </div>
            ...
            {step < steps.length - 1 ? (
              <button
                ...
                className={`rounded-full border px-5 py-1.5 text-[11px] font-semibold uppercase tracking-[0.3em] transition ${
                  allowNext
                    ? 'border-amber-400/60 bg-amber-500/80 text-slate-900 hover:bg-amber-400/90'
