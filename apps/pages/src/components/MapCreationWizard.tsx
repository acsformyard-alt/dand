        ...
        <div className="flex h-full flex-col overflow-hidden">
          ...
          {step === 1 && (
            <div className="flex flex-1 items-stretch justify-center">
              <div className="flex h-full w-[90vw] max-w-5xl flex-col rounded-3xl border border-slate-800/70 bg-slate-900/70 p-8">
          ...
          {step === 2 && (
            <div className="flex h-full min-h-0 flex-1 justify-center">
              <div className="flex h-full min-h-0 w-[90vw] max-w-5xl rounded-3xl border border-slate-800/70 bg-slate-900/70 p-4">
                <div
