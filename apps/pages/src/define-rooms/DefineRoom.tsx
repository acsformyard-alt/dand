...
const INVESTIGATION_MARKER_ICON = `
  <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
      d="M12 7.875a1.875 1.875 0 00-1.875 1.875.75.75 0 11-1.5 0 3.375 3.375 0 016.75 0c0 1.125-.525 1.875-1.463 2.4-.674.373-1.012.73-1.17 1.102-.151.357-.117.75-.117 1.173v.102a.75.75 0 01-1.5 0v-.102c0-.435-.003-1.136.258-1.75.284-.674.83-1.146 1.405-1.469.66-.365.867-.642.867-1.456A1.875 1.875 0 0012 7.875zm0 8.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0z"
    />
  </svg>
`;
